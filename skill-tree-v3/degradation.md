---
description: >-
  Optional per-skill mechanic introduced in v3. Players must keep earning XP in
  a category to maintain unlocked skill effects.
---
...
{% content-ref url="development/listeners.md" %}
[listeners.md](development/listeners.md)
{% endcontent-ref %}
...
When a skill is depleted, players see a stamina indicator on the skill tile. The lang strings used for the UI live in `configs/sh.lang.lua`:

```lua
['degradation_xp']           = "Skill Stamina",
['degradation_warning']      = "Skill stamina is running low",
['degradation_critical']     = "Skill stamina is critically low!",
['degradation_depleted']     = "Skill effect disabled - earn XP to restore!",
['degradation_reactivation'] = "Reactivation: %s / %s XP",
```
